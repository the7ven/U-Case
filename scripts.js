...
const PRODUCTS = [
  ...
  { name: "Coque Transparente", teaser: "Transparente anti-jaunissement, croix imprimée et verset.", spec: "Transparente anti-jaunissement, croix fine imprimée et verset « Psalms 46:5 — God is within her, she will not fall ». Bords renforcés, boutons précis.", price: 5000, cat: "coques", img: "images/coque%20transparente.png",
    models: ["iPhone 13 Pro", "iPhone 15 Pro"] },
  { name: "Écaille Ambrée", teaser: "Effet écaille de tortue ambrée, grip trois billes intégré.", spec: "Coque effet écaille de tortue ambrée, avec grip décoratif intégré à trois billes (ambre, noir, léopard). Finition brillante, contour rigide translucide.", price: 5000, cat: "coques", badge: "Nouveau", img: "images/%C3%89caille%20Ambr%C3%A9e.png",
  ...
  { name: "Léopard Menthe", teaser: "Léopard menthe & marron, dragonne corde tressée assortie.", spec: "Coque rigide brillante à motif léopard menthe et marron, avec dragonne en corde tressée assortie et mousqueton métallique. Protection caméra intégrée.", price: 5000, cat: "coques", badge: "Nouveau", img: "images/L%C3%A9opard%20Menthe.png",
    models: ["iPhone 14 Pro Max", "iPhone 15 Pro Max"] },
  { name: "Tweed Chic", teaser: "Dos en tweed pied-de-poule, contour noir, dragonne cuir à pompon.", spec: "Coque à dos en tissu tweed pied-de-poule (beige, noir, rouge, kaki), contour rigide noir. Livrée avec dragonne en cuir à pompon et breloque cœur.", price: 3500, cat: "coques", badge: "Nouveau", img: "images/tweed-chic.png",
    models: ["iPhone 13", "iPhone 13 Pro Max", "iPhone 14 Plus", "iPhone 15 Pro Max", "iPhone 16 Pro Max"] },
  { name: "Cœur Anatomique", teaser: "Transparente rose, cœur anatomique illustré et citation.", spec: "Coque transparente rose à illustration de cœur anatomique et citation imprimée. Livrée avec cache-objectif et film de protection d'écran assortis.", price: 4000, cat: "coques", badge: "Nouveau", img: "images/coeur-atomique.png",
    models: ["iPhone 12 Pro Max", "iPhone 14 Plus", "iPhone 14 Pro", "iPhone 14 Pro Max", "iPhone 15 Pro", "iPhone 15 Pro Max", "iPhone 16"] },
  { name: "Suédine Camel", teaser: "Grain suédine camel doux au toucher, boutons et tour caméra dorés.", spec: "Une coque volontairement épurée, où la texture fait tout le travail : un grain suédine doux au toucher, dans un camel chaud, associé à des touches dorées sur les boutons et le tour caméra. Pensée pour celles et ceux qui veulent une protection discrète mais qui ne fait pas « plastique ».", price: 3500, cat: "coques", badge: "Nouveau", img: "images/suedine%20camel.png",
    models: ["iPhone 12 Pro Max", "iPhone 13", "iPhone 13 Pro Max", "iPhone 14 Plus", "iPhone 14 Pro Max", "iPhone 15 Plus", "iPhone 16", "iPhone 16 Pro Max"] },
  { name: "Cœurs Believe", teaser: "Pluie de petits cœurs bicolores sur fond transparent, citation au dos.", spec: "Une coque légère et positive, avec une pluie de petits cœurs bicolores sur fond transparent et une citation encourageante (« Believe in yourself, and you will be unstoppable. ») imprimée au dos. Simple, mais avec un vrai message.", price: 5000, cat: "coques", badge: "Nouveau", img: "images/coeur%20believe.png",
    models: ["iPhone 11", "iPhone 12", "iPhone 12 Pro", "iPhone 13 Pro", "iPhone 13 Pro Max", "iPhone 14 Pro", "iPhone 15 Pro", "iPhone 15 Pro Max", "iPhone 16"] },
  ...
  { name: "Trio Vintage", teaser: "Lot de 3 : nœuds sur rose, pois noirs sur écru, rayures rose et noir.", spec: "Un mini-vestiaire de motifs intemporels revisités : le nœud romantique, le pois graphique, la rayure marinière détournée en rose et noir. Trois pièces qui peuvent se porter séparément ou en collection, avec une identité commune facile à reconnaître.", price: 4000, cat: "coques", badge: "Nouveau", img: "images/trio-vintage.png",
    models: ["iPhone 17 Pro Max"] },
  { name: "Minou Kawaii 3D", teaser: "Silicone épais rose, gros nœud sculpté 3D, chat blanc à cœurs et étoiles.", spec: "Une coque ludique en silicone épais, avec un gros nœud sculpté en 3D au niveau du bloc caméra et une illustration de chat blanc à cœurs et étoiles. Un format qui plaît surtout pour son côté kawaii et tactile.", price: 3500, cat: "coques", badge: "Nouveau", img: "images/hello-kitty.png",
    models: ["iPhone 13 Pro", "iPhone 14 Plus", "iPhone 14 Pro Max", "iPhone 15 Pro", "iPhone 16"] },
  { name: "Doux Feuillage", teaser: "Fond transparent fumé, médaillon taupe cerclé d'or et branche au trait doré.", spec: "Un fond transparent parcouru de volutes blanches façon fumée, sur lequel se détache une forme galet gris taupe cerclée d'un fin trait doré — presque comme un médaillon. À l'intérieur, une citation discrète et une branche illustrée d'un seul trait doré donnent à la coque un rendu épuré et un peu poétique, loin des motifs trop chargés. Les coins renforcés absorbent les chocs sans casser la légèreté du design.", price: 4000, cat: "coques", badge: "Nouveau", img: "images/Doux%20Feuillage.png",
